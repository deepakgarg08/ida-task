...
//        upp.execute();
		...
		//inspite of data.ttl use endpoint
	...
	//	Model resultss = qexec.execConstruct();
		...
		System.out.println("-sparql_result:"+sparql_result);

		File file = new File("data4.ttl");
...
//	}
	...
	@RequestMapping("/fetchx") //Fetch one by one
